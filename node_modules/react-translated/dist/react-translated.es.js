import { Component, PureComponent, cloneElement, createElement } from 'react';
import { any, bool, func, shape } from 'prop-types';

//      

var TranslatedShape = shape({
...
var createSubscribe = function createSubscribe(_ref) {
  ...
  return _temp = _class = function (_React$PureComponent) {
    ...
    createClass(Subscribe, [{
      key: 'render',
      value: function render() {
        return createElement(Component$$1, _extends({}, this.props, { translated: this.context.translated }));
      }
    }, {
...
var createTranslate = function createTranslate(_ref) {
  ...
  Translate.contextTypes = {
    isInAParentText: renderer === 'native' ? bool : any
  };
...
var createRenderer = function createRenderer(_ref) {
  ...
  return function (_ref2) {
    ...
    var chunks = render({
      ...
      return typeof chunk === 'string' ? chunk : cloneElement(chunk, { key: index });
    });
...
export { Provider, Translate, Translator$1 as Translator };
